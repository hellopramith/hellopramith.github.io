...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		aspectRatio:        1,          /* Aspect ratio of the ImageFlow container (width divided by height) */
		buttons:            false,          /* Toggle navigation buttons */
		captions:           true,           /* Toggle captions */
		circular:           false,          /* Toggle circular rotation */
		imageCursor:        'default',      /* Cursor type for all images - default is 'default' */
		ImageFlowID:        'imageflow',    /* Default id of the ImageFlow container */
		imageFocusM:        0,            /* Multiplicator for the focussed image size in percent */
		...
		percentLandscape:   432,            /* Scale landscape format */
		percentOther:       205,            /* Scale portrait and square format */
