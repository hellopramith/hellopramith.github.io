...
function checkcityname(field, rules, i, options){
  if (field.val() == "") {
     return "Type your city name";
  }}
...
function checkcountry(field, rules, i, options){
  if (field.val() == "") {
     return "Type your country name";
  }}  
function checkphone(field, rules, i, options){
  if (field.val() == "") {
     return "Type your phone number";
  }} 
function checkwebsite(field, rules, i, options){
  if (field.val() == "") {
     return "Type your website name";
  }}   
function checkanimate(field, rules, i, options){
  if (field.val() == "") {
     return "Type your animation info";
  }} 
function checkknows(field, rules, i, options){
  if (field.val() == "") {
     return "Select how do you know us";
  }}     
function checkcaptch(field, rules, i, options){
  if (field.val() == "") {
     return "Type captcha code here";
  }}     
