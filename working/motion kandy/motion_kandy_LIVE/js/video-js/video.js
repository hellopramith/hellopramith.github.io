...
_V_.PlayButton = _V_.Button.extend({
  ...
  onClick: function(){
	  ...
	  for(var vi = 0; vi < htmlPlayer.length; vi++){
		htmlPlayer[vi].pause();
	  }
    this.player.play();
  }
...
_V_.PlayToggle = _V_.Button.extend({
  ...
  onClick: function(){
    ...
    if (this.player.paused()) {
	 ...
	 var htmlPlayer1 = document.getElementsByTagName('video');
	  for(var vi1 = 0; vi1 < htmlPlayer1.length; vi1++){
		htmlPlayer1[vi1].pause();
	  } 
      this.player.pause();
    }
  },
...
_V_.Player = _V_.Component.extend({
  ...
  onEnded: function(){
    if (this.options.loop) {
	  ...
	  $('.vjs-loading-spinner').addClass('imHide');
	   $('.vjs-poster').show();
...
================================================================================ */
  ...
  remainingTime: function(){
	 ...
	 if( Math.round(this.duration() - this.currentTime())==1){  
		//  $('.vjs-poster').show();
